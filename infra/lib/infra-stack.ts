...
export class InfraStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    webSocketApi.addRoute('buzz', {
      integration: new WebSocketLambdaIntegration('BuzzIntegration', buzzHandler),
    });

    webSocketApi.addRoute('startQuiz', {
      integration: new WebSocketLambdaIntegration('StartQuizIntegration', startQuizHandler),
    });
